  ...
  return (
    <div ref={searchRef} className="relative w-full max-w-2xl mx-auto">
      ...
      {isOpen && results.length > 0 && (
        <div className="absolute top-full mt-2 w-full bg-card border border-border rounded-xl shadow-card overflow-hidden z-50 animate-slide-up">
      ...
      {isOpen && isLoading && (
        <div className="absolute top-full mt-2 w-full bg-card border border-border rounded-xl p-4 text-center text-muted-foreground animate-fade-in">
          Searching...
        </div>
      )}
    </div>
